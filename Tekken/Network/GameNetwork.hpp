...
#include "../../Engine/Hashing/Hash.hpp"
#include "../../Engine/Vector/Vector3.hpp"
#include "../../Engine/Network/Packets/NetPacket.hpp"
    ...
    */
    struct ManageEntity : public GameNetwork {
        ...
        ManageEntity(MGE::Vector3f pos, EntityType type, MGE::Hash id, MGE::NetId netid, uint16_t player = 0)
          : GameNetwork(RtypeNetCommande::ManageEntity), entityPosition(pos), entityType(type), entityID(id), netId(netid), playerID(player) {}
    };
    ...
    struct NetParalax : public GameNetwork {
        ...
        */
        explicit NetParalax(MGE::Hash sprite1 = MGE::Hash(), float spd1 = 0.0f, MGE::Hash sprite2 = MGE::Hash(), float spd2 = 0.0f)
          : GameNetwork(RtypeNetCommande::Paralax), spriteID1(sprite1), speed1(spd1), spriteID2(sprite2), speed2(spd2) {}
    };
    ...
    struct SpaceShipEvent : public GameNetwork {
        ...
        */
        explicit SpaceShipEvent(SpaceShipEventType eventType = SpaceShipEventType::Shot, MGE::NetId target = MGE::NetId())
          : GameNetwork(RtypeNetCommande::SpaceShipEvent), spaceShipEventType(eventType), spaceShipEventTarget(target) {}
    };
    ...
    */
    ...
    class RtypeNetwork {
        public:
            ...
            static void SendRPCServerOrderGameManagement(GameState gameState, const MGE::World &world);
